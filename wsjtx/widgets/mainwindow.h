...
private slots:
  ...
  void addAutoIgnoredStation(QString const& callsign, QString const& reason = QString {});
  ...
  void on_cbAutoHunt_toggled(bool b);
  void on_cbAutoPOTA_toggled(bool b);
  ...
  void refreshAutoIgnoredList();
  void on_btn_clearPotaWorked_clicked();
  void refreshPotaWorkedList();
...
private:
  ...
  qint32  m_points=-99;
  qint32  m_score=0;
  qint32  m_sessionQSOCount=0;
  qint32  m_totalQSOCount=0;
  qint32  m_fDop=0;
  qint32  m_echoSec0=0;
  qint32  m_fetched=0;
  qint32  m_position;
  ...
  // Auto CQ / Auto Call (ported from WSJT-Z)
  ...
  int     m_tailenderFreq = 0;
  bool    m_tailenderTxFirst = false;
  bool    m_prioTxFirst = false;
  int     m_prioFreq = 0;
  QString m_prioGrid;
  bool    m_autoModeSwitch = false;
  bool    m_TxFirstLock = false;
  QVector<QVector<int>> busySlots;
  QSet<QString>  m_potaWorkedToday;  // POTA Hunt: "CALL:BAND" worked today (UTC)
  ...
  // Omega auto-mode debug log (writes to omega_auto_debug.log in data dir)
  void autoLog(QString const& msg);
  QFile          m_autoDebugFile;
