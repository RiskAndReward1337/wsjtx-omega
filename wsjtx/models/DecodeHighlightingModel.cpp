...
QList<DecodeHighlightingModel::HighlightInfo> const DecodeHighlightingModel::impl::defaults_ = {
  {Highlight::MyCall, true, {Qt::black}, {{0xff, 0x66, 0x66}}}
  , {Highlight::Continent, false, {Qt::black}, {{0xff, 0x00, 0x63}}}
  , {Highlight::ContinentBand, false, {Qt::black}, {{0xff, 0x99, 0xc2}}}
  , {Highlight::CQZone, false, {Qt::black}, {{0xff, 0xbf, 0x00}}}
  , {Highlight::CQZoneBand, false, {Qt::black}, {{0xff, 0xe4, 0x99}}}
  , {Highlight::ITUZone, false, {Qt::black}, {{0xa6, 0xff, 0x00}}}
  , {Highlight::ITUZoneBand, false, {Qt::black}, {{0xdd, 0xff, 0x99}}}
  , {Highlight::DXCC, false, {Qt::black}, {{0xff, 0x00, 0xff}}}
  , {Highlight::DXCCBand, false, {Qt::black}, {{0xff, 0xaa, 0xff}}}
  , {Highlight::Grid, true, {Qt::black}, {Qt::red}}
  , {Highlight::GridBand, true, {Qt::white}, {Qt::blue}}
  , {Highlight::Call, false, {Qt::black}, {{0x00, 0xff, 0xff}}}
  , {Highlight::CallBand, false, {Qt::black}, {{0x99, 0xff, 0xff}}}
  , {Highlight::LotW, false, {Qt::black}, {}}
  , {Highlight::CQ, true, {Qt::black}, {{0x66, 0xff, 0x66}}}
  , {Highlight::Tx, true, {Qt::black}, {Qt::yellow}}
};
