...
subroutine packcall(callsign, ncall, text)
   ...
   character*6, intent(inout) :: callsign
...
subroutine unpackcall(ncall, word, iv2, psfx)
   ...
   character*12, intent(out):: word
   integer,     intent(out) :: iv2
   character*4, intent(out) :: psfx
...
999 if (word(1:3) .eq. '3D0') word = '3DA0'//word(4:)
 ...
 subroutine packgrid(grid,ng,text)
   ...
   character*4, intent(inout) :: grid   ! modified when mapping extended reports
