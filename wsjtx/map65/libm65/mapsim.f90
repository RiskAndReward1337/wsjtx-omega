...
contains
  ...
  subroutine dopspread(cwave,fspread)
    ...
    real*8, intent(in) :: fspread
    complex, allocatable ::  cspread(:)
    real*4 :: twopi, df, b, f, x, a, phi1, phi2
    real*4 :: sum, p, avep, fac
    complex :: z
    integer :: i
...
! Generate simulated data for testing of MAP65
  ...
  complex z,zx,zy
  real*8 fcenter,fsample,samfac,dt,twopi,phi,dphi,rms
  real*8 :: f, dt0, fa, fb, fdop, snrdb, rmsdb, rad, fac, pol, a, b, sig, snrdbx, xphi
  logical bq65
